...
# Usage : run the script with AWS_FOLDER as a parameter e,g: ./copy_from_s3.sh CC-MAIN-2014-15
...
# AWS_FOLDER format: CC-MAIN-2014-15
AWS_FOLDER="$1"
...
DOWNLOAD_FILE="$FOLDER_NAME/downloadedfiles.txt"
touch $DOWNLOAD_FILE
